				...
				<td style="vertical-align:top;">
					<div class="tools">
						<c:if test="${(usermenu.freadonly=='w' || usermenu.freadonly=='a')}">
							<span>
								<a class="a" href="javascript:void(0);" onclick="group.edit()">
									<img src="${rc.contextPath }/images/a.gif" width="20" height="20">
									<b>添加&nbsp;</b>
								</a>
								<a class="a" href="javascript:void(0);" onclick="group.ajaxLoadById()">
									<img src="${rc.contextPath }/images/m.gif" width="20" height="20">
									<b>修改&nbsp;</b>
								</a>
								<a class="a" href="javascript:void(0);" onclick="group.deleteSource()">
									<img src="${rc.contextPath }/images/d.gif" width="20" height="20">
									<b>删除&nbsp;</b>
								</a>
								<a class="a" href="javascript:void(0);" onclick="menu.load()">
									<img src="${rc.contextPath }/images/a.gif" width="20" height="20">
									<b>权限分配&nbsp;</b>
								</a>
							</span>
...
<script type="text/javascript" src="${rc.contextPath}/js/self/usergroup.js"></script>
</body>
</html>