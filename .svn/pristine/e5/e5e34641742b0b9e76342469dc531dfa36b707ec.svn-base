					...
					<div class="tools">
						<span>
							<c:if test="${usermenu.freadonly=='w' || usermenu.freadonly=='a'}">
								<a class="a" href="javascript:void(0);" onclick="node.ajaxLoadById()">
									<img src="${rc.contextPath }/images/a.gif" width="20" height="20">
									<b>添加&nbsp;</b>
								</a>
								<a class="a" href="javascript:void(0);" onclick="node.ajaxLoadById(1)">
									<img src="${rc.contextPath }/images/m.gif" width="20" height="20">
									<b>修改&nbsp;</b>
								</a>
								<a class="a" href="javascript:void(0);" onclick="node.deleteSource()">
...
<script type="text/javascript" src="${rc.contextPath}/js/self/node.js"></script>
</body>
</html>