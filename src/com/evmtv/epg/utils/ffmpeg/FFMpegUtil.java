...
public class FFMpegUtil implements IStringGetter{  
     ...
     * @throws IOException 
     */  
    public int getRuntime() throws IOException, InterruptedException{  
        runtime = 0;  
     ...
     * @throws IOException 
     */  
    public boolean isSupported() throws IOException, InterruptedException{  
        isSupported = true;  
     ...
     * @throws IOException 
     */  
    public void makeScreenCut( String imageSavePath , String screenSize ) throws IOException, InterruptedException{  
        cmd.clear();  
        cmd.add(ffmpegUri);  
        cmd.add("-i");  
        cmd.add(originFileUri);  
     ...
     * @throws IOException 
     */
    public void iframeToJpg(String imageSavePath) throws IOException, InterruptedException{
    	cmd.clear();  
        cmd.add(ffmpegUri);  
        cmd.add("-i");  
        cmd.add(originFileUri);
    ...
    public void videoTransfer(   
            ...
            int audioCollection,  
            double quality,  
            double fps ) throws IOException, InterruptedException{  
        cmd.clear();  
        cmd.add(ffmpegUri);  
        cmd.add("-i");  
        cmd.add(originFileUri);  
